      ...
      <section id="about" className="py-20 bg-light">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            <h1 className="text-4xl font-bold mb-4">Hi, I'm Richardnak Uch</h1>
            <p className="text-xl mb-6">
              A passionate full-stack developer with a love for creating elegant solutions to complex problems.
            </p>
            <div className="flex space-x-4">
              <button className="bg-primary text-dark px-4 py-2 rounded flex items-center">
              ...
              <button className="bg-white text-dark px-4 py-2 rounded border border-primary flex items-center">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
