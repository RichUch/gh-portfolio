...
const ContactForm = () => {
  ...
  <div className="form-container container mx-auto px-4 dark:text-white">
    ...
    <div className="max-w-md mx-auto">
      <form className="space-y-2 flex flex-col mb-1" onSubmit={handleSubmit}>
        ...
        <Button type="submit" className="contact_send_button my-2 hover:bg-white/70 dark:bg-dark/90 dark:text-white dark:border-dark dark:hover:bg-dark">
